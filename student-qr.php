            	...
            	<div class="row">
                	<div class="col-md-12">
                    	<div class="panel panel-default">
                              ...
                              <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Upload QR Code</h4>
                                  </div>
                            ...
                            <div class="panel panel-body" style="padding:0px 50px;">
                            	<div class="row">
                            		...
                            		<div class="col-md-4">
                                    	...
                                    	<div class="form-group">
                                        	<img class="img-thumbnail" id="imgQR" src="img/qrcode.png" style="width:100%">
                                        </div>
                                		<div class="form-group">
                                        	<button type="file" class="btn btn-block btn-lg btn-warning" data-toggle="modal" data-target="#uploadModal">
                                            	<span class="glyphicon glyphicon-edit">Upload</span>
                                           </button>
                                        </div>
                                    </div>
                                    <div class="col-md-4"></div>
    ...
    <script>
		$(document).ready(function() {
			$("#btUpload").click(function(data){
				...
				if(document.getElementById("qrFile").files.length == 0){
					alert("upload your qrcode");
				}
				else{
					var file = document.getElementById("qrFile").files[0].name;
					$("#imgQR").attr('src',file);
