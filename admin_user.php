    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" role="navigation">
        <div class="container topnav">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand topnav classwork" href="admin_user.php">ClassWork</a>
            </div>
            ...
            <ul class="list-inline intro-social-buttons">
                ...
                <li>
                    <form action="pdf/html2pdf.php" method="post" target="_blank">
                    	<a id="topdf" href="#" class="btn-admin" onClick="printPDFStd()"><i><img src="img/Print-64.png" alt="" style="height:23px;"></i><span class="network-name">    PRINT TO PDF</span></a>&nbsp;&nbsp;
