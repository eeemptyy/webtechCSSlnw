...
//             alert("out: " + data);
            var obj = JSON.parse(data);
                        ...
                        for (var i = 0, len = obj.length; i < len; ++i) {
                            var objIn = obj[i];
                            html += '<div class="form-group"><label for="comment"><b><u>'+objIn['TeacherFName']+ ':</u></b></label><p style="margin-left:30px;">'+objIn['comment_text']+
                   '</p></div><br />';
//                            html += '<tr>';
...
//                            html += "</tr>";
                        ...
                        html += '<div class="form-group"><input id="submitChangPws" class="btn btn-default" style="font-size:12px; color:black; float:right;" type="button" value="Delete"></div><br />';
